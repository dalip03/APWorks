      ...
      <div className="relative max-w-5xl w-full grid grid-cols-1 md:grid-cols-2 md:grid-rows-2 gap-2 bg-transparent z-10">
        ...
        <div className="relative p-4 min-h-[230px] rounded-md bg-[#292947] text-white overflow-hidden shadow-lg group cursor-pointer overflow-visible">
          ...
          <div className="relative z-10">
            <h3 className="font-bold text-xl mb-1">Engineering Services</h3>
            <div className="uppercase text-[#c6e0ff] font-semibold text-[12px] mb-1 tracking-wider">
              MVPs, Data Platforms, Scalable Systems
            </div>
            <div className="font-bold text-base mb-1 text-white">
              From Idea to Infrastructure
            </div>
            <p className="text-white/80 text-sm pr-30 mb-2">
              <span className="mb-1">
...
/>
          ...
          <div className="relative z-10">
            ...
            <div className="text-[#3686FD] font-semibold text-[12px] mb-1 tracking-wider">
            ...
            <div className="text-[#3686FD] text-xs font-semibold mb-1">
              Where strategy meets execution velocity
            </div>
            <p className="text-white/80 text-xs pl-40">
...
/>
          ...
          <div className="relative z-10">
            <h3 className="font-bold text-xl mb-1">Tech Consulting</h3>
            <div className="uppercase text-[#3686FD] font-semibold text-[12px] mb-1 tracking-wider">
              Fractional CTO, Modernization, Strategic IT Advisory
            </div>
            <div className="font-bold text-2xl mb-1 text-white">
              Strategy That Ships
            </div>
            <div className="text-[#3686FD] font-semibold text-xs mb-1">
              Embedded leadership. Deep alignment.
            </div>
            <p className="text-white/80 text-xs pr-36">
...
/>
          ...
          <div className="relative z-10">
            <h3 className="font-bold text-2xl mb-1 text-end">
              Business Consulting
            </h3>
